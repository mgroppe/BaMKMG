...
\begin{document}
	...
	\\Aufgabenstellung dieser Arbeit ist es, Pokémon Go und vergleichbare Produkte zu analysieren und gute Aspekte aus diesen aufzugreifen. Danach sollen diese mit Aspekten aus Computer- und Konsolenspielen, die mehr Langzeitmotivation bieten, kombiniert werden, um einen Prototypen für ein AR-Rollenspiel zu entwickeln, der sowohl Leute anspricht, die eher simple Spiele  bevorzugen als auch solche, die durch Spieltiefe auf längere Zeit Spaß suchen. 
	Mittels Testpersonen verschiedener Altersgruppen und mit unterschiedlicher Spielerfahrung sowie diversen Vorlieben hinsichtlich der Komplexität soll anschließend geprüft werden, ob das Spiel diese Ziele erfüllt.
	...
	In 2016 haben gleichzeitig an einem Tag 23 Millionen Nutzer gespielt.%search
	\\
	...
	Das 1997 veröffentlichte Playstation-Spiel Final Fantasy tactics und sein 2003 erschienener Nachfolger für den Gameboy Advance sind Klassiker unter den Taktik-Rollenspielen. Ausgereifte und komplexe Level- und Klassensysteme sorgen für viele Möglichkeiten bei der Charakter-Entwicklung, was zusammen mit den stark variierenden Kämpfen für Langzeitmotivation sorgt. Stil und Grafik sind bei beiden Titeln hochwertig. Während Final Fantasy Tactics jedoch eine ausgereifte und komplexe Geschichte vorweisen kann, steht diese bei den Nachfolgern eher im Hintergrund.
...
Unsere Items werden, wie im Genre Standard ist, automatisch generiert und kommen in verschiedenen Seltenheitsstufen und Leveln/Stärken vor. Unsere Absicht war, dass seltene Items große Vorteile bringen, damit Spieler sich freuen, wenn sie sie bekommen.
...
In unserem finalen Konzept unterscheiden sich Kreaturen durch die folgenden fünf Werte: \begin{itemize}
	\item Lebenspunkte geben an, wieviel eine Kreatur aushält. Sinken ihre Lebenspunkte auf null, ist sie kampfunfähig und kann an dieser Schlacht nicht mehr teilnehmen.
...
\\Gegnergruppen setzen sich aus zufälligen Konstellationen der Klassen zusammen und bekommen zunehmend mehr Statuspunkte, um auszugleichen, dass sie keine Items tragen. Das Level der Gegner hängt dabei vom Level der Spielergruppe ab. Anfangs sind Gegner schwächer, weil Spieler noch keine Items haben. Damit Kämpfe sich abwechslungsreich spielen, wird nicht nur drei gegen drei gekämpft, sondern es können auch einzelne oder auch zwei Gegner auftauchen. Damit die Kämpfe nicht trivial werden, haben zwei Gegner jeweils 25\% mehr Leben, Angriff und Initiative (Figuren mit mehr Initiative sind früher dran) als einzelne Gegner, während ein einzelner Gegner eine Herausforderung darstellen soll und als Boss auftritt, mit 2,5-fachen Statuswerten in Lebenspunkten, Schaden und Initiative, einem größeren Modell und besseren Belohnungen. Damit Boss-Kämpfe besonders bleiben, treten sie deutlich seltener auf.
...
\\Usere Quests unterteilen wir in kleine und große Quests. Während kleine Quests in der Regel innerhalb einer Stunde abschließbar sein und für Kurzzeit-Spaß sorgen sollen, sind große Quests dazu gedacht, Spieler über einen längeren Zeitraum ein Ziel zu geben. Dadurch wird für Langzeit-Motivation gesorgt.
\newpage
...
In der vierten Activity kann man eigene Charaktere erstellen. Über die vier Bilder kann man die Klasse des Charakters aussuchen und über das Textfeld einen Namen eingeben. Die Activity zeigt einem zusätzlich die Basis-Statuswerte der momentan ausgewählten Klasse, die sich stark unterscheiden, an.
\newpage
\begin{figure}[H]
		\centering
...
In der auf der Karte aufgerufenen Kampf-Activity kann der von Unity kompilierte Code abgespielt werden. Um zwischen Java und Unity-Code zu kommunizieren, verwenden wir Java Native Interface, kurz JNI. JNI ist eine Programmierschnittstelle, die es uns erlaubt, von Unity aus Java Funktionen aufzurufen, die sich in unserer Kampf-Activity befinden. Wir benutzen JNI, um die Kampfinformationen, die der Activity mitgeteilt werden, im Unity-Code aufzurufen und um, nachdem der Kampf abgeschlossen ist, zurück zur Haupt-Activity zu kommen.
\newpage
...
Der Stil hatte den Anspruch, sowohl auf Smartphones als auch auf Tablets gut auszusehen, ein breites Publikum anzusprechen und sich vom normalen abheben. Das hieß, dass es mehrere Herausforderung zu meistern gab:
\begin{enumerate}
	\item 
...
\item Die hohe Detaildichte, welche für die Entwicklung für Tablets erforderlich ist, benötigt einen relativ hohen Zeitaufwand. Folglich mussten Animationen vom Grundmodell aus einfach zu erzeugen sein und eine Ansicht gewählt werden, in der dies nicht negativ auf die Optik des Spiels auswirkt.
\end{enumerate}
...
\\Danach wurden mehrere Skizzen erstellt, um eine geeignete Balance zwischen realistischem Look und übertriebem Comic-Look zu finden. Erste Versuche (s. Abb. \ref{earlydesign}) waren stärker überzeichnet und an den sogenannte Chibi-Zeichenstil angelehnt, da ein vergrößerter Kopf leicht auszumachen ist und eine gute Differenzierung der verschiedenen Figuren ermöglichte. Es gab allerdings Bedenken, dass diese Optik Hardcore-Spieler abschrecken könnte, die wir ebenfalls ansprechen wollten. Daher wurde der Kopf in folgenden Versuchen etwas weniger überzeichnet, der restliche Körper etwas realistischer proportioniert und zusätzlich die Bewaffnung etwas vergrößert. Da geplant war, einige Modelle durch farbliche Veränderung sowie das Abändern einiger Details als neue Modelle zu benutzten, erlaubte eine größere Waffe eine gute Erkennbarkeit von Elementen, die für Statuswerte wichtig sein sollten. So sollte der Spieler intuitiv verstehen können, dass die Figur mit dem Schild mehr Schaden aushält und die Figur mit den zwei Äxten mehr Schaden anrichtet. Dies wäre bei reinem Verändern der farblichen Gestaltung nicht möglich gewesen.
\begin{figure}[H]
		%	\raggedleft
		\raggedleft
...
Da hier, im Gegensatz zu der Priesterin, der Arm mit dem Reif im Vordergrund steht, wurde die Armschiene stärker ausgearbeitet. Die Haut wurde dunkler gemacht, was einen starken Kontrast zu dem beigen Leinen erzeugte und der Figur ein unmenschlicheres Äußeres gab. Dies erleichterte die Erklärung, warum er mobiler war.
\newpage
